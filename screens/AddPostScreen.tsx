  ...
  return (
    <SafeAreaView style={styles.container}>
      <Card>
        ...
        />
        <View>
          <Text style={[styles.headers, styles.bannerSelect]}>
            Select a banner for your post
          </Text>
          <View style={styles.selector}>
            <RNPickerSelect
              ...
              items={[
                ...
                { label: 'keaLogo', value: 3, color: 'orange' },
              ]}
            />
          </View>
        </View>
        <Button title='AddPost' onPress={handleAddPost}>
          Add Post!
        </Button>
      </Card>
    </SafeAreaView>
